...
foreach(_expectedTarget etcd-cpp-api-core etcd-cpp-api)
...
# Create imported target etcd-cpp-api-core
add_library(etcd-cpp-api-core INTERFACE IMPORTED)

set_target_properties(etcd-cpp-api-core PROPERTIES
  INTERFACE_LINK_LIBRARIES "etcd-cpp-api"
)

# Create imported target etcd-cpp-api
...
file(GLOB CONFIG_FILES "${_DIR}/etcd-targets-*.cmake")
